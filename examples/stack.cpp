...
static double sum3(int a, int b, double c) { return (a + b) * c; }
...
int main() {
  ...
  // ... which is a little cumbersome. Instead we might apply a fitting function
  // to our stack.
  std::cout << "(a + b) * c = " << luwra::apply(state, sum3) << std::endl;
