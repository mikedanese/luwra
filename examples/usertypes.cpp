...
int main() {
  ...
  // This function also registers a garbage-collector hook and a string
  // representation function.
  // Both can be overwritten using the third parameter, which lets you add
  // custom meta methods.
  luwra::registerUserType<Point(double, double)>(
      state,
      // Constructor name
      "Point",
      // Methods which shall be availabe in the Lua user data, need to be
      // declared here
      {LUWRA_MEMBER(Point, scale), LUWRA_MEMBER(Point, x),
