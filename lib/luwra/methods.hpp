...
template <typename T> struct MethodWrapper {
  static_assert(sizeof(T) == -1, "Undefined template MethodWrapper");
};
...
struct MethodWrapper<R (T::*)(A...) const volatile> {
  ...
  template <MethodPointerType meth>
  static inline R hook(const volatile T *parent, A &&... args) {
    return (parent->*meth)(std::forward<A>(args)...);
  }

  template <MethodPointerType meth> static inline int invoke(State *state) {
...
struct MethodWrapper<R (T::*)(A...) const> {
  ...
  template <MethodPointerType meth>
  static inline R hook(const T *parent, A... args) {
    return (parent->*meth)(std::forward<A>(args)...);
  }
...
struct MethodWrapper<R (T::*)(A...) volatile> {
  ...
  template <MethodPointerType meth>
  static inline R hook(volatile T *parent, A... args) {
    return (parent->*meth)(std::forward<A>(args)...);
  }
...
struct MethodWrapper<R (T::*)(A...)> {
  ...
  template <MethodPointerType meth> static inline R hook(T *parent, A... args) {
    return (parent->*meth)(std::forward<A>(args)...);
  }
