...
template <typename I> struct NumericTest {
  static void test(lua_State *state) {
...
struct TautologyTest {
  static void test(lua_State *) {}
};

template <typename B, typename I>
using SelectNumericTest = typename std::conditional<
    luwra::internal::NumericContainedValueBase<I, B>::qualifies, NumericTest<I>,
    TautologyTest>::type;
